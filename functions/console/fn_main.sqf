...
_Object addAction ["Select Item",{[_this select 3,"Items"] call TG_fnc_menu},_Object];
_Object addAction ["Select Air Frame",{[_this select 3,"Aircraft"] call TG_fnc_menu},_Object];
_Object addAction ["Select Ground Vic",{[_this select 3,"Ground"] call TG_fnc_menu},_Object];
_Object addAction["-------------------",{}];
{
